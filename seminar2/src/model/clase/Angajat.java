...
public class Angajat extends Aplicant{
	...
	private int salariu;
	private static int venitProiectAngajat=10;
	...
	public static void setVenitProiectAngajat(int venitProiectAngajat) {
		Angajat.venitProiectAngajat = venitProiectAngajat;
	}
